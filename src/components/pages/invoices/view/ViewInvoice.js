...
class ViewInvoice extends Component {
    ...
    render() {
        return(
            <GenericPage title={`${I18n.t('pages.viewInvoice.title')} #${this.state.invoice.invoiceNo}`} pageContentClasses="view-invoice-page-content" pageNav={ this.state._pageNavigation }>
