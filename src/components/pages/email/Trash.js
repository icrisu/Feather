...
class Trash extends Component {
    ...
    state = {
        _pageNavigation: [{ label: 'Dashboard', to: '/' }, { label: 'Email', to: '/email/inbox' }, { label: 'Trash' }]
    }
    ...
    render() {
        return(
            <GenericPage title={I18n.t('pages.trash.title')} pageContentClasses="emails-page-content" pageNav={ this.state._pageNavigation }>
