...
class Spam extends Component {
    ...
    state = {
        _pageNavigation: [{ label: 'Dashboard', to: '/' }, { label: 'Email', to: '/email/inbox' }, { label: 'Spam' }]
    }
    ...
    render() {
        return(
            <GenericPage title={I18n.t('pages.spam.title')} pageContentClasses="emails-page-content" pageNav={ this.state._pageNavigation }>
